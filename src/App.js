...
const onAddToBasket = async (obj) => {
  try {
    ...
    if (findCards) {
      ...
      const {data} = await axios.post('https://6397f57f86d04c7633a1987c.mockapi.io/basket', obj);
      setBasketCards(prev => prev.map(item => {
...
const onAddToFavourite = async (obj) => {
  try {
    ...
    const {data} = await axios.post('https://6397f57f86d04c7633a1987c.mockapi.io/favourites', obj);
